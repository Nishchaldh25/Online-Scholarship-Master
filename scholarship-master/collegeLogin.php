...
<html>
	...
	<section class="container black-text">
		...
		<form class="blue lighten-4" action="collegeLogin.php" method="POST">
			<label style="color:blue">College ID</label>
			...
			<div class="center">
				<input type="" name="submit" value="submit" class="btn brand z-depth-0">
			</div>
		</form>
	</section>
